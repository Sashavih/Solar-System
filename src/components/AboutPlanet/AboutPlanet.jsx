        ...
        <div>
            {props.name ?
                <section className="planets"><h2 className='planets-box__title'>{props.name}</h2><div className='planets-box'>
                    ...
                    </p></div ><div className='planets-box__item'><h3 className='subtitle'>Physical Characteristics</h3><p><span>Dimension </span> {props.dimension}
                    </p><p><span>Mass </span>: {props.mass.massValue}</p><p><span>Gravity :</span> {props.gravity}</p><p><span>Flattening </span> {props.flattening}
